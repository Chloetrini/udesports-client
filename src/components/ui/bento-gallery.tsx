...
type ImageItem = {
  ...
  type?: "image" | "video" // defaults to "image" when omitted
}
...
// Renders either an image or a video tile, used in both the grid and the modal
const MediaThumb = ({
  item,
  className,
}: {
...
// Modal component for displaying the selected item
const ImageModal = ({
  item,
  onClose,
}: {
