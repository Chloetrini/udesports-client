...
const FilterPlayers = ({
  ...
  return (
    <div className='flex flex-col md:flex-row-reverse flexRowAdjust lg:flex-row px-5 md:px-10 mb-5 py-5 shadow-white shadow-md gap-5 md:gap-10 md:items-end md:justify-end lg:justify-start'>

      {/* SEARCH BAR */}
      <div className='border-b border-[#8E8E8E] pb-3 md:w-[300px] h-fit lg:w-[400px]'>
      ...
      <div className='flex flex-col flexColAdjust lg:flex-row gap-[16px] md:gap-8 lg:gap-14'>
        ...
        <div className='flex flex-col md:flex-row gap-[16px] lg:gap-9'>
          <div className='flex items-center gap-4'>
            ...
            <p className='text-[18px] md:text-[15px] lg:text-[18px] text-[#8E8E8E] font-manrope'>Filter by:</p>
          </div>
        ...
        <div className='flex flex-col md:flex-row gap-[16px]'>
          <div>
            <p className='text-[18px] md:text-[15px] lg:text-[18px] text-[#8E8E8E] font-manrope'>Status</p>
          </div>
