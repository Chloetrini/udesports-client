  ...
  return (
    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 mb-5">
        <h2 className="text-sm font-semibold text-gray-900 mb-4">Site Information</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
          <div className="flex flex-col gap-1.5">
             <label className="text-xs font-medium text-gray-600">
              Site Title
          </label>
          <input type="text" value={siteTitle} onChange={(e) => setSiteTitle(e.target.value)} className="border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:border-green-500"/>
          </div>

          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium text-gray-600">Contact Info</label>
            <input type="text" value={contactInfo} onChange={(e) => setContactInfo(e.target.value)} className="border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:border-green-400"  />
          </div>

          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium text-gray-600">Mail</label>
            <input type="email" value={mail} onChange={(e) => setMail(e.target.value)} className="border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:border-green-400" />
          </div>
          <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium text-gray-600">X (Twitter)</label>
            <input type="text" placeholder="x.com/" value={twitter} onChange={(e) => setTwitter(e.target.value)} className="border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:border-green-400" />
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 mb-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
          <div className="flex flex-col gap-1.5">
           <label className="text-xs font-medium text-gray-600">Admin Name</label>
           <input type="text" value={adminName} onChange={(e) => {setAdminName(e.target.value); setAdminErrors({...adminErrors, adminName: ""}) }} 
           className={`border px-3 py-2 text-sm focus:outline-none focus:border-green-500 ${adminErrors.adminName ? 'border-red-400' : 'border-gray-200'}`} />
           {adminErrors.adminName && <p className="text-xs text-red-500">{adminErrors.adminName}</p>}
          </div>
          <div className="flex flex-col gap-1.5">
           <label className="text-xs font-medium text-gray-600">Admin Email</label>
           ...
           className={`border px-3 py-2 text-sm focus:outline-none focus:border-green-400 ${adminErrors.adminEmail ? 'border-red-400' : 'border-gray-200'}`} />
           {adminErrors.adminEmail && <p className="text-xs text-red-500">{adminErrors.adminEmail}</p>}
          </div>
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium text-gray-600">Role</label>
            <select disabled className="border border-gray-200 px-3 py-2 text-sm text-gray-400 bg-gray-50 cursor-not-allowed focus:outline-none">
          ...
          <div className="flex flex-col gap-1.5">
           ...
           <div className="relative">
             <input type={showPassword ? "text" : "password"} placeholder="........" value={password} onChange={(e)=>  {setPassword(e.target.value); setAdminErrors({...adminErrors, password: ""}) }}
                className="w-full border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:border-green-400 pr-10" />
          ...
          <div className="flex flex-col gap-1.5">
           ...
           className={`w-full border px-3 py-2 text-sm focus:outline-none focus:border-green-400 pr-10 ${ adminErrors.confirmPassword ? 'border-red-400' : 'border-gray-200'}`} />
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        <h2 className="text-sm font-semibold text-gray-900 mb-4">Invite Admin Account</h2>
              ...
              <div key={i} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input type="text" value={admin.name} disabled={editingIndex !== i} onChange={(e) => {const updated = [...inviteAdmins]; updated[i].name = e.target.value; setInviteAdmins(updated)}}
                   className={`border px-3 py-2 text-sm focus:outline-none ${editingIndex === i ? 'border-green-400' : 'border-gray-200 bg-gray-50'}`} />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-medium text-gray-600">Admin Email</label>
                ...
                <div className="flex flex-col gap-1.5">
                 ...
                 className={`border px-3 py-2 text-sm focus:outline-none ${editingIndex === i ? 'border-green-400 text-gray-600' : 'border-gray-200 bg-gray-50 text-gray-400'}`}>
