...
echo "Applying script18: fix player photo positioning (heads up, clear of the name/stats text), hide goals/assists/rating/appearance when not set, add a Professional filter chip on the public players page, and show a Dashboard link in the navbar when an admin is logged in..."

mkdir -p "$(dirname "src/components/player-information/FetchPlayers.tsx")"
cat > "src/components/player-information/FetchPlayers.tsx" << 'UDES_EOF_3342074715365433625'
...
UDES_EOF_3342074715365433625

mkdir -p "$(dirname "src/components/player-information/PlayerFullDetails.tsx")"
cat > "src/components/player-information/PlayerFullDetails.tsx" << 'UDES_EOF_4891869926121884914'
...
UDES_EOF_4891869926121884914

mkdir -p "$(dirname "src/components/home/SectionTwo.tsx")"
cat > "src/components/home/SectionTwo.tsx" << 'UDES_EOF_8751995443827029891'
...
UDES_EOF_8751995443827029891

mkdir -p "$(dirname "src/components/player-information/FilterPlayers.tsx")"
cat > "src/components/player-information/FilterPlayers.tsx" << 'UDES_EOF_3947133265957856503'
...
UDES_EOF_3947133265957856503

mkdir -p "$(dirname "src/components/universal/NavBar.tsx")"
cat > "src/components/universal/NavBar.tsx" << 'UDES_EOF_4391025162065220479'
...
UDES_EOF_4391025162065220479

mkdir -p "$(dirname "src/routes/admin/add-player/index.tsx")"
cat > "src/routes/admin/add-player/index.tsx" << 'UDES_EOF_3080503955570654235'
