...
echo "Applying script14: match the admin photo-upload preview to the public portrait crop, and crop (rather than stretch) player photos everywhere they display..."

mkdir -p "$(dirname "src/routes/admin/add-player/index.tsx")"
cat > "src/routes/admin/add-player/index.tsx" << 'UDES_EOF_3107817739993663827'
...
UDES_EOF_3107817739993663827

mkdir -p "$(dirname "src/components/player-information/FetchPlayers.tsx")"
cat > "src/components/player-information/FetchPlayers.tsx" << 'UDES_EOF_8275879994860974539'
...
UDES_EOF_8275879994860974539

mkdir -p "$(dirname "src/components/player-information/PlayerFullDetails.tsx")"
cat > "src/components/player-information/PlayerFullDetails.tsx" << 'UDES_EOF_4202338434096470786'
...
UDES_EOF_4202338434096470786

mkdir -p "$(dirname "src/components/home/SectionTwo.tsx")"
cat > "src/components/home/SectionTwo.tsx" << 'UDES_EOF_5178504371232579589'
